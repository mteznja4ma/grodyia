...
type CommandClient interface {
	Exec(ctx context.Context, in *message.Invocation, opts ...grpc.CallOption) (*message.Return, error)
}
...
func (c *commandClient) Exec(ctx context.Context, in *message.Invocation, opts ...grpc.CallOption) (*message.Return, error) {
	out := new(message.Return)
	err := c.cc.Invoke(ctx, "/rpc.Command/Exec", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CommandServer interface {
	Exec(context.Context, *message.Invocation) (*message.Return, error)
...
func (UnimplementedCommandServer) Exec(context.Context, *message.Invocation) (*message.Return, error) {
...
func _Command_Exec_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.Command/Exec",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommandServer).Exec(ctx, req.(*message.Invocation))
	}
